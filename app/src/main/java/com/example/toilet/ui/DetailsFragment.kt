    ...
    private fun getSubCategory(category: String, placeName: String): String? {
        val subCategories = when (category) {
            "mosque" -> mapOf(
                ...
                "Beyoğlu Akşemsettin Cami" to "beyogluaksemsettinMosq",
                "Çiftecevizler Cami" to "ciftecevizlerMosq",
                "Çağlayan Cami" to "caglayanyeniMosq",
                "Cengiz Topel Cami" to "cengiztopelMosq",
                "Darülaceze Cami" to "darulacezeMosq",
                ...
                "Hacı Tevfikzade Cami" to "hacitevfikzadeMosq",
